...
Avocado is one of Kenya’s most economically significant horticultural crops, with rapidly expanding production and export value [@hcd2023report]. Despite this growth, premature harvesting remains widespread, largely because farmers and value chain actors lack scalable, objective tools for determining physiological maturity across diverse smallholder orchards. Traditional maturity assessments—such as destructive sampling and dry matter analysis—are accurate but costly, labour‑intensive, and spatially limited, making them unsuitable for routine monitoring at regional scales [@whiley1986phenology; @salazar1998flowering].

Remote sensing offers a promising alternative. Multisensor satellite platforms such as Sentinel‑2 and Landsat 8/9 provide dense, high‑resolution time series capable of capturing canopy dynamics and phenological transitions in perennial crops [@bolton2021continental; @zhang2003monitoring]. However, applications in East African smallholder systems remain limited due to heterogeneous canopies, intercropping, and variable management practices [@jaetzold2012farm].
...
NDRE exhibited the smallest variation (~10–15%) and weakest separability between Fruit Development and Maturity, consistent with stable chlorophyll levels during late‑season physiological stabilization [Gitelson, 2005]. This suggests that red‑edge indices may be more useful for detecting early‑season transitions than late‑season maturity.
...
Overall, these findings demonstrate that NDWI provides the strongest phenological signal, while NDVI and EVI offer redundant structural information, and NDRE contributes early‑season chlorophyll sensitivity. These insights have direct implications for remote‑sensing‑based decision‑support systems, particularly for detecting Flowering and early Fruit Development — key management windows for irrigation, nutrient application, and pest risk assessment.

These findings provide a foundation for further research, where phenology‑based maturity modelling will be developed using the same fused multisensor time series.
